    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            if (!jwtTokenUtil.isTokenExpired(token)) {
                ...
                // [FIX QUAN TRỌNG]: Ép kiểu Integer
                Integer userId = jwtTokenUtil.extractClaim(token, claims -> claims.get("userId", Integer.class));
                String roleName = jwtTokenUtil.extractClaim(token, claims -> claims.get("role", String.class));

                // Dummy User để cache Authentication
